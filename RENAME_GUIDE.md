...
- Full namespace: `Umkipur\SyliusExamplePlugin`
...
1. **Main plugin class file:**
   ```
   src/UmkipurSyliusExamplePlugin.php → src/{CompanyName}{PluginName}.php
   ```
...
- Twig namespace references from `@UmkipurSyliusExamplePlugin` to `@{CompanyName}{PluginName}`
...
| Find | Replace |
|------|---------|
| `Umkipur\SyliusExamplePlugin` | `{CompanyName}\{PluginName}` |
| `UmkipurSyliusExamplePlugin` | `{CompanyName}{PluginName}` |
| `UmkipurSyliusExampleExtension` | `{CompanyName}{PluginName}Extension` |
| `@UmkipurSyliusExamplePlugin` | `@{CompanyName}{PluginName}` |
| `Tests\Umkipur\SyliusExamplePlugin` | `Tests\{CompanyName}\{PluginName}` |
...
- `Umkipur\SyliusExamplePlugin\UmkipurSyliusExamplePlugin`
- `@UmkipurSyliusExamplePlugin/templates/...`
